...
public abstract class SimilarityMeasure {
     ...
     *
     * @param s1 the first synset between which we are looking for the
     *           similarity.
     * @param s2 the other synset between which we are looking for the
     *           similarity.
     ...
     *
     * @param s1  one of the synsets between which we are storing a similarity.
     * @param s2  the other synset between which we are storing a similarity.
     ...
     * @return a new instance of a similarity measure as defined by the
    ...
    public static SimilarityMeasure newInstance(Dictionary dict, URL confURL) throws Exception {
        ...
        try {
            ...
            in = new BufferedReader(new InputStreamReader(confURL.openStream(), "UTF-8"));
     ...
     *
     * @param s1 one of the synsets between which we want to know the
     *           similarity.
